...
public class RateLimitManager {
	 ...
	 * @param channel
	 *            The channel of the rate limit. Can be <code>null</code> for
	 *            non-channel related limits.
	 * @param retryAfter
	 *            The retryAfter.
	 */
	 ...
	 * @param type
	 *            The type of the rate limit.
	 * @return Gets the rate limit of the given type in milliseconds or
	 *         <code>-1</code> if not limited.
	 */
