...
/**
 * This logger is used if no SLF4J compatible logger was found. It uses the
 * logger classes provided by java itself.
 */
public class JavacordLogger extends MarkerIgnoringBase {
	...
	/**
	 * Class constructor. It's recommended to use
	 * {@link LoggerUtil#getLogger(String)}.
	 *
	 * @param name
