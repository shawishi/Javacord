...
public class LoggerUtil {
	...
	/**
	 * Sets whether debugging should be enabled or not. This has only an effect
	 * if the default {@link de.btobastian.javacord.utils.JavacordLogger} is
	 * used.
	 *
	 * @param debug
	 *            Whether debugging should be enabled or not.
	 */
	...
	/**
	 * Checks whether debugging is enabled or not. This has only an effect if
	 * the default {@link de.btobastian.javacord.utils.JavacordLogger} is used.
	 *
