...
public interface Channel extends MessageReceiver {
	...
	/**
	 * Gets an invite builder. An invite builder is used to easily create
	 * invites.
	 *
	 ...
	 *
	 * @param role
	 *            The role which overwrites the permissions.
	...
	/**
	 * Updates the name of the channel. If you want to update the topic and
	 * position too, use {@link #update(String, String, int)}. Otherwise the
	 * first update will be overridden (except you wait for it to finish using
	 * {@link Future#get()}).
	 *
	 * @param newName
	...
	/**
	 * Updates the topic of the channel. If you want to update the name and
	 * position too, use {@link #update(String, String, int)}. Otherwise the
	 * first update will be overridden (except you wait for it to finish using
	 * {@link Future#get()}).
	 *
	...
	/**
	 * Updates the position of the channel. If you want to update the name and
	 * topic too, use {@link #update(String, String, int). Otherwise the first
	 * update will be overridden (except you wait for it to finish using
	 * {@link Future#get()}).
	 *
	 * @param newPosition
	 *            The new topic of the channel.
