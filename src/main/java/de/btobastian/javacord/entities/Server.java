...
public interface Server {
	 ...
	 * @return The channel with the given id. <code>Null</code> if the server
	 *         has no channel with the given id.
	 */
	 ...
	 * @return The voice channel with the given id. <code>Null</code> if the
	 *         server has no channel with the given id.
	 */
	 ...
	 * @param id
	 *            The id of the user.
	 * @return The user with the given id. <code>Null</code> if the user is no
	 *         member of this server.
	 */
	public User getMemberById(String id);

	/**
	 * Gets a collection with all known members on this server. For large
	 * servers some members might not be included in this collection because
	 * they are offline.
	 *
	 ...
	 * @param id
	 *            The id of the role.
	 * @return The role with the given id. <code>Null</code> if the role does
	 ...
	 *            The name of the channel.
	 * @param callback
	 *            The callback which will be informed when the channel was
	 *            created.
	 * @return The created channel.
	 */
	 ...
	 *
	 * @param callback
	 *            The callback which will be informed when the request has
	 *            finished.
	 * @return An array with all invites.
	 */
	 ...
	 *            The user.
	 * @param roles
	 *            The roles to set. This will override the existing roles of the
	 *            user.
	 ...
	 *            The user to ban.
	 * @param deleteDays
	 *            Deletes all messages of the user which are younger than
	 *            <code>deleteDays</code> days.
	 * @return A future which tells us whether the ban was successful or not.
	 */
	 ...
	 *
	 * @param callback
	 *            The callback which will be informed when the request finished.
	 * @return An array with all bans.
	 */
	 ...
	 *
	 * @param callback
	 *            The callback which will be informed when the role was created.
	 * @return The created role.
	 */
	public Future<Role> createRole(FutureCallback<Role> callback);

	/**
	 * Updates the name of the server. Use
	 * {@link #update(String, Region, BufferedImage)} if you want to change
	 * region or/and icon, too or your changes may be overwritten.
	 *
	 * @param newName
	...
	/**
	 * Updates the region of the server. Use
	 * {@link #update(String, Region, BufferedImage)} if you want to change the
	 * name, too or your changes may be overwritten.
	 *
	 * @param newRegion
	...
	/**
	 * Updates the icon of the server. Use
	 * {@link #update(String, Region, BufferedImage)} if you want to change the
	 * name, too or your changes may be overwritten.
	 *
	 * @param newIcon
	 ...
	 *
	 * @param newName
	 *            The name of the server. Set it to <code>null</code> if you
	 *            don't want to change the name.
	 * @param newRegion
	 *            The region of the server. Set it to <code>null</code> if you
	 *            don't want to change the region.
	 * @param newIcon
	 *            The icon of the server. Set it to <code>null</code> if you
	 *            don't want to change the icon.
	 * @return A future which tells us whether the update was successful or not.
	 */
	...
	/**
	 * Checks whether the server is large or not. A large server has more than
	 * 250 members. Discord don't send offline users for large servers so
	 * {@link #getMemberCount()} might be greater than the size of
	 * {@link #getMembers()}.
	 *
	 ...
	 * @return A future which tells us whether the authorization was successful
	 *         or not.
	 */
	 ...
	 *            The id of the bot's application.
	 * @param permissions
	 *            The permissions the bot should get on join.
	 * @return A future which tells us whether the authorization was successful
	 *         or not.
	 */
	 ...
	 * @param id
	 *            The id of the emoji.
	 * @return The emoji with the given id. <code>Null</code> if the emoji does
	 *         not exist on this server.
	 */
	 ...
	 * @return The emoji with the given name. <code>Null</code> if the emoji
	 ...
	 *
	 * @return The url of the server icon. <code>Null</code> if the server has a
	 *         default icon.
	 */
	 ...
	 *
	 * @param callback
	 *            A callback which will be informed when the image is recieved.
	 * @return A future containing the webp image data for the icon.
	 */
