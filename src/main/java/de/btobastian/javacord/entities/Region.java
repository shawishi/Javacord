...
public enum Region {
	...
	AMSTERDAM("amsterdam", "Amsterdam"), BRAZIL("brazil", "Brazil"), EU_CENTRAL("eu-central", "EU Central"), EU_WEST(
			"eu-west",
			"EU West"), FRANKFURT("frankfurt", "Frankfurt"), LONDON("london", "London"), SINGAPORE("singapore",
					"Singapore"), SYDNEY("sydney", "Sydney"), US_CENTRAL("us-central", "US Central"), US_EAST("us-east",
							"US East"), US_SOUTH("us-south", "US South"), US_WEST("us-west", "US West"),
	/**
	 ...
	 * @param key
	 *            The key of the region.
	 * @return The region with the given key. {@link Region#UNKNOWN} if no
	 *         region for the given key was found.
	 */
