...
public interface VoiceChannel {
	...
	/**
	 * Updates the name of the channel. If you want to update position too, use
	 * {@link #update(String, int)}. Otherwise the first update will be
	 * overridden (except you wait for it to finish using {@link Future#get()}).
	 *
	 * @param newName
	...
	/**
	 * Updates the position of the channel. If you want to update the name too,
	 * use {@link #update(String, int)}. Otherwise the first update will be
	 * overridden (except you wait for it to finish using {@link Future#get()}).
	 *
	 * @param newPosition
