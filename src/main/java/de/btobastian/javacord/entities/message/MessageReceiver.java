...
/**
 * This interface represents a message receiver. The most common message
 * receivers are {@link de.btobastian.javacord.entities.Channel} and
 * {@link de.btobastian.javacord.entities.User}.
 */
public interface MessageReceiver {
	 ...
	 * @return The sent message. Canceled if something didn't work (e.g. missing
	 *         permissions).
	 */
	 ...
	 *            The content of the message.
	 * @param tts
	 *            Whether the message should be tts or not.
	 * @return The sent message. Canceled if something didn't work (e.g. missing
	 *         permissions).
	 */
	 ...
	 *            The content of the message.
	 * @param embed
	 *            An embed that should be added to the message.
	 * @return The sent message. Canceled if something didn't work (e.g. missing
	 *         permissions).
	 */
	 ...
	 *            The content of the message.
	 * @param callback
	 *            The callback which will be informed when the message was sent
	 *            or sending failed.
	 * @return The sent message. Canceled if something didn't work (e.g. missing
	 *         permissions).
	 */
	 ...
	 * @param file
	 *            The file to upload.
	 * @return The sent message containing the file. Canceled if something
	 *         didn't work (e.g. missing permissions).
	 */
	 ...
	 *            The file to upload.
	 * @param callback
	 *            The callback which will be informed when the file was uploaded
	 *            or upload failed.
	 * @return The sent message containing the file. Canceled if something
	 *         didn't work (e.g. missing permissions).
	 */
	 ...
	 *            The file to upload.
	 * @param comment
	 *            An additional comment to your file.
	 * @return The sent message containing the file.
	 */
	 ...
	 *            The maximum amount of messages.
	 * @param callback
	 *            The callback which will be informed when the message history
	 *            is available.
	 * @return A message history.
	 */
	 ...
	 *
	 * @param before
	 *            Only gets the messages before the given message.
	 * @param limit
	 *            The maximum amount of messages.
	 * @return A message history.
	 */
	 ...
	 *
	 * @param beforeId
	 *            Only gets the messages before the message with the given id.
	 * @param limit
	 *            The maximum amount of messages.
	 * @return A message history.
	 */
	 ...
	 *
	 * @param after
	 *            Only gets the messages after the given message.
	 * @param limit
	 *            The maximum amount of messages.
	 * @return A message history.
	 */
	 ...
	 *
	 * @param afterId
	 *            Only gets the messages after the message with the given id.
	 * @param limit
	 *            The maximum amount of messages.
	 * @return A message history.
	 */
