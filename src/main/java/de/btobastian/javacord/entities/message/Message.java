...
public interface Message extends Comparable<Message> {
	...
	/**
	 * Gets the {@link Channel channel} of the message. <code>Null</code> if the
	...
	/**
	 * Gets the user the message was sent to. <code>Null</code> if the message
	 * is no private message.
	 *
	...
	/**
	 * Gets the {@link MessageReceiver receiver} of the message. Could be a
	 * channel or a user. If you are the receiver the author of the message will
	 * be returned.
	 *
	 * @return The receiver of the message. If you are the receiver, the author
	 *         of the message will be returned.
	 */
	 ...
	 *            The new content of the message.
	 * @param embed
	 *            The new embed to include with the message on edit.
	 * @return A future which tells us if the edit was successful or not.
	 */
	 ...
	 * <p>
	 * It's recommended to use an emoji java library (e.g.
