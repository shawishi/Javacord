...
public class Javacord {
	 ...
	 *
	 * @param email
	 *            The email address which should be used to connect to the
	 *            account.
	 * @param password
	 *            The password which should be used to connect to the account.
	 * @return A new instance of DiscordAPI.
	 ...
	 *
	 * @param token
	 *            The token which is required to login.
	 * @param bot
